			...
			<div class="easyui-tabs" fit="true" >
				<div title="Task specification" style="padding:10px">
					<table id="utaskTable1" width="100%" cellpadding="2">
						...
						<tr>
							<td style='width:120px'>任务备注</td>
							<td><textarea id="unodeRemark" rows="5" style='width:90%;'
									name="nodeRemark"></textarea></td>
						</tr>
						<tr>
				...
				<div title="控件参数" style="padding:10px">
					<table id="comparaTable" width="100%" cellpadding="2">
<script type="text/javascript">

var processpojo = ${pojo};

jQuery(document).ready(function() {
	$("#browseTask_form").form("load", processpojo);
	$("#utaskTable0 #unodeName").val( processpojo.nodeName);
...
//  	n = new Number(n);
	switch(controlTPL.inputType ){
		case 1: 
			...
			break;
		case 2: 
			inputStr = "<textarea name='"+ controlTPL.paraId+"' style='height:60px;width:100%;font-size: 12px;'>"+controlTPL.defValue+"</textarea>";
			break;
		case 3: 
			inputStr = "<input class='easyui-validatebox' type='text' name='"+ controlTPL.paraId+"' style='width:90%;' value='"+controlTPL.defValue+"'/>";
			break;
...
// 	idField : "nodeId",
	...
	rownumbers : false,
	queryParams : {
		jdata : encodeURI($.toJSON({ act: VIRTUE.act.QUERY, condition: {nodeId: processpojo.nodeId, jobInsId: processpojo.jobInsId  }, operator : {} })),
	}
});
...
function taskparam_append() {
	if (taskparam_endEditing()) {
		$('#taskparam_grid').datagrid('appendRow', { nodeId: processpojo.nodeId });
