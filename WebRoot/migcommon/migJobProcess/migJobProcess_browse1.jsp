...
<html>
<head>
	<title>Instance Monitor(domainer)--已作废</title>
...
<script type="text/javascript" src="../migcommon/migJobProcess/migJobProcess_browse1.js"></script>
</head>
<body rightmargin="0" bottommargin="0" leftmargin="0" topmargin="0" class="easyui-layout" onload="">
	...
	<div id="taskContextMenu" class="easyui-menu" style="width:160px;">
		<div data-options="disabled: true,iconCls:'icon-stop'" onclick="javascript: app.f_pauseTask( insId, nodes[app.zindex].nodeId )">Stop Task</div>
		<div>
			<span>Set Task State</span>
			<div style="width:120px;">
				<div data-options="disabled: true,iconCls:'icon-init'" onclick="javascript: app.f_setTaskInit( insId, nodes[app.zindex].nodeId )">Init</div>
				<div data-options="disabled: true,iconCls:'icon-finish'" onclick="javascript: app.f_setTaskFinish( insId, nodes[app.zindex].nodeId )">Finish</div>
				<div data-options="disabled: true,iconCls:'icon-pause'" onclick="javascript: app.f_setTaskPause( insId, nodes[app.zindex].nodeId )">Pause</div>
				<div data-options="disabled: true,iconCls:'icon-skip'" onclick="javascript: app.f_setTaskSkip( insId, nodes[app.zindex].nodeId )">Skip</div>
			</div>
		</div>
	...
	<div id="jobContextMenu" class="easyui-menu" style="width:160px;">
		...
		<div data-options="disabled: false,iconCls:'icon-search'" onclick="javascript: app.f_viewJobIns_open_window( insId, nodes[app.zindex] )">View Setting</div>
		<div data-options="disabled: false,iconCls:'icon-search'" onclick="javascript: app.showTaskLog(app.zindex)">View Log</div>
	</div>
	
	<div id="blankContextMenu" class="easyui-menu" style="width:120px;">
		<div data-options="disabled: true,iconCls:'icon-run'" onclick="javascript: app.f_startJob( insId )">Start Job</div>
		<div data-options="disabled: true,iconCls:'icon-pause'" onclick="javascript: app.f_pauseJob( insId )">Pause Job</div>
		<div data-options="disabled: true,iconCls:'icon-back'" onclick="javascript: app.f_setJobInit( insId )">Reset Job</div>
		<div class="menu-sep"></div>
		<div data-options="disabled: true,iconCls:'icon-unlock'" onclick="javascript: app.f_unlockJob( insId )">Unlock Job</div>
		<div class="menu-sep"></div>
...
// var t=setTimeout("refreshState()",5*1000);
/** 每隔3秒刷新一次状态 **/
function refreshState(){
	$.ajax({
	   ...
	   success: function(oResponse){
			setTimeout("refreshState()",10*1000);
