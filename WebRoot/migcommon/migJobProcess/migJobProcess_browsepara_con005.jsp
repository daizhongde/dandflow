...
//  	n = new Number(n);
	switch(controlTPL.inputType ){
		...
		case 2: 
			...
			inputStr = "<textarea id='exec-sql' name='"+ controlTPL.paraId+"' style='height:230px;width:100%;font-size: 12px;'>"+controlTPL.defValue+"</textarea>"
			+"<a href='javascript:void(0)' class='easyui-linkbutton' iconCls='icon-ok' " + disabledattr 
			+"onclick=\"app.updateSQL('${pojo.jobInsId}','${pojo.comId}','"+ controlTPL.paraId + "' );\">Submit SQL</a>";
			break;
		case 3: 
			inputStr = "<input class='easyui-validatebox' type='text' name='"+ controlTPL.paraId +"' style='width:90%;' value='"+controlTPL.defValue+"'/>";
			break;
...
<script type="text/javascript">
app.updateSQL = function( jobInsId, comId, paraId  ){
	console.log("jobInsId:"+jobInsId+",comId:"+comId+",paraId:"+paraId);
		...
		$.ajax({
			...
			data:{
				...
				paraValue: document.getElementById("exec-sql").value
			},
