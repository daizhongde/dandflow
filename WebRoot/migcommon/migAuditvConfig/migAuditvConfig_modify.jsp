		    	...
		    	<table align="center" width="100%">
		    		...
		    		<tr>
		    			...
		    			<td>
		    				...
		    				value="${map.table_name }" data-options="required:true"></input>
		    			</td>
		    			<td>Expectation:</td>
		    			<td colspan="3">
		    		...
		    		<tr>
		    			...
		    			<td><input class="easyui-validatebox" type="text" id="operator_U" name="operator" 
		    				value="${map.operator }" data-options="required:true"></input></td>
		    			<td>Auditor:</td>
		    			<td><input class="easyui-validatebox" type="text" id="audit_author_U" name="audit_author" 
		    				value="${map.audit_author }" data-options="required:true"></input></td>
		    		</tr>
		    		<tr>
		    			<td>Description:</td>
		    			<td colspan="3">
			...
			data-options="
				...
				buttons: [{
					...
					handler:function(){
						...
						$('#src_db_connect_U').combogrid( 'setValue', migsrcconn );
