...
<body rightmargin="0" bottommargin="0" leftmargin="0" topmargin="0" class="easyui-layout">
	...
	<div id="taskContextMenu" class="easyui-menu" style="width:120px;">
		<div data-options="disabled:false" onclick="javascript: app.f_modifyPara_open_window( app.zindex )">编辑作业入口</div>
		<div data-options="disabled:false" onclick="javascript: app.removeTask( )">删除所有该作业入口的副本</div>
	...
	<div id="blankContextMenu" class="easyui-menu" style="width:120px;">
		<div data-options="disabled:true" onclick="javascript: app.f_modifyPara_open_window( app.zindex )">新建记录</div>
		<div data-options="disabled:true" onclick="javascript: app.f_modifyPara_open_window( app.zindex )">从剪贴板粘贴</div>
