...
<html>
<head>
<title>修改新建定时实例</title>
</head>
  <body>
   	<script type="text/javascript">
   	var action = "edit";//edit,add,view   , mysoftstone zddaia employeeNo98974,author 戴忠戴 ,author daizhongde QQ:413881461
	/*
	 * 
			...
			<div style="padding:5px 0 10px 30px">
			    <form id="u_form" method="post" action="" style="margin:0;padding:0;">
					...
					<tr>
		    			<td>Job Instance:</td>
		    			<td>
							<input id="case_id_U" name='case_id'/>
						</td>
		    		</tr>
		    		<tr>
		    			<td>Job Name:</td>
		    			<td><input class="easyui-validatebox" type="text" id="jobname_U" name="jobname" value="${map.jobname }"
		    				data-options="required:true" style="width:300px"></input></td>
		    		</tr>
		    		<tr>
		    			<td>Description:</td>
		    			<td><textarea id="remark_U" name="remark" value="${map.remark }"
		    				style="height:60px;width:500px;font-size: 12px;"></textarea></td>
		    		</tr>
		    	</table>
		    	<input type="hidden" id="cronExpression_U" name="cronexpression" value=""/>
		    </form>
  	<!-- pills navigater -->
...
update.submitForm = function (){
	$("#cronExpression_U").val(cronExpression);
	...
	jQuery.post( getContextPath()+"/curd/migInsQuartzCURDmodify.action", 
		{
			tableName : tableName,
...
// 		activeTabIndex = e.target.parentNode.id;
...
// 			console.log("选定对应的radio,ckRunFlagRadioIndex:"+ckRunFlagRadioIndex);
		}
// 		console.log("激活对应的tab,activeTabIndex:"+activeTabIndex);
		//激活对应的tab
