...
public class TAsiainfoEmployee implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1711833295534163786L;
	...
	/** default constructor */
	public TAsiainfoEmployee() {
	}

	/** minimal constructor */
	public TAsiainfoEmployee(String employee_number) {
		this.employee_number = employee_number;
	}

	/** full constructor */
	public TAsiainfoEmployee(String employee_number, String sbu_id,
			...
			Integer age, Integer assignment_id, Timestamp birth_date,
			String class_, String working_location, String seat_no,
			String mobile, String nt_account, Integer supervisor_id,
			String supervisor_name, String highest_degree, Timestamp hire_date) {
		this.employee_number = employee_number;
		this.sbu_id = sbu_id;
		this.sbu = sbu;
