...
/**
 * MigAuditfMainResultHisId entity. @author MyEclipse Persistence Tools
 */

public class MigAuditfMainResultHisId implements java.io.Serializable {
	...
	/** default constructor */
	public MigAuditfMainResultHisId() {
	}

	/** full constructor */
	public MigAuditfMainResultHisId(String faresMainId, String faresDryrunId,
			String faresSerial) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MigAuditfMainResultHisId))
			return false;
		MigAuditfMainResultHisId castOther = (MigAuditfMainResultHisId) other;
