...
/**
 * MigAuditfMainResultHis entity. @author MyEclipse Persistence Tools
 */

public class MigAuditfMainResultHis implements java.io.Serializable {

	// Fields

	private MigAuditfMainResultHisId id;
	...
	/** default constructor */
	public MigAuditfMainResultHis() {
	}

	/** minimal constructor */
	public MigAuditfMainResultHis(MigAuditfMainResultHisId id, Integer domain) {
		this.id = id;
		this.domain = domain;
	}
	...
	public MigAuditfMainResultHisId getId() {
		return this.id;
	}

	public void setId(MigAuditfMainResultHisId id) {
		this.id = id;
	}
