...
/**
 * MigAuditfDetailResultId entity. @author MyEclipse Persistence Tools
 */

public class MigAuditfDetailResultId implements java.io.Serializable {
	...
	/** default constructor */
	public MigAuditfDetailResultId() {
	}

	/** minimal constructor */
	public MigAuditfDetailResultId(String faresBitmap, Timestamp faresCreatetime) {
		this.faresBitmap = faresBitmap;
		this.faresCreatetime = faresCreatetime;
	}

	/** full constructor */
	public MigAuditfDetailResultId(String faresMainId, String faresSerial,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MigAuditfDetailResultId))
			return false;
		MigAuditfDetailResultId castOther = (MigAuditfDetailResultId) other;
