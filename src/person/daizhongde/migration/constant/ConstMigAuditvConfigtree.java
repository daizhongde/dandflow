 ...
 *
 */
public class ConstMigAuditvConfigtree extends AbstractConstant {
	
	private static org.slf4j.Logger log = LoggerFactory.getLogger(ConstMigAuditvConfigtree.class);
