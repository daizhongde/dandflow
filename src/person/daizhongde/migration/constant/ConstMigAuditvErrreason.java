 ...
 *
 */
public class ConstMigAuditvErrreason extends AbstractConstant {
	
	private static org.slf4j.Logger log = LoggerFactory.getLogger(ConstMigAuditvErrreason.class);
