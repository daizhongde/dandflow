 ...
 *
 */
public class ConstMigCodedetailDefine extends AbstractConstant {
	
	private static org.slf4j.Logger log = LoggerFactory.getLogger(ConstMigCodedetailDefine.class);
