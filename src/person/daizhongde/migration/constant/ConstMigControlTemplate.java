 ...
 *
 */
public class ConstMigControlTemplate extends AbstractConstant {
	
	private static org.slf4j.Logger log = LoggerFactory.getLogger(ConstMigControlTemplate.class);
