 ...
 *
 */
public class ConstCommon extends AbstractConstant {
	
	private static org.apache.log4j.Logger log = Logger.getLogger(ConstCommon.class);
	...
	private static String configFileDirectory = INIT.configFileDirectory+"/common";
