 ...
 * @date 2015-01-07
 */
public class MigAuditvConfigtreeCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected MigAuditvConfigtree pojo;
	protected MigAuditvConfigtreeService dataService;
	...
	public String add() {
		try{
			dataService.add(this.getJdata(), super.getLoginUser());
		}catch(Exception e){
			e.printStackTrace();
			Throwable e2 = e;
	...
	public String modifyContent2NULL(){
		int i = 0;//update row count
		try{
			//@return The number of entities updated or deleted or insert.
			i = dataService.modifyContent2NULL(this.getJdata());
		}catch(Exception e){
			e.printStackTrace();
			Throwable e2 = e;
			while(e2.getCause() != null ){
	...
	public void setPojo(MigAuditvConfigtree pojo) {
		this.pojo = pojo;
	}
	 ...
	 * @return
	 */
	public MigAuditvConfigtree getPojo() {
		return pojo;
	}
