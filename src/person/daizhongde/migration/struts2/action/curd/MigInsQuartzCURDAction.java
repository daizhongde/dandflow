...
import person.daizhongde.migration.spring.service.quartz.MigInsQuartzService;
 ...
 * @date 2015-01-07
 */
public class MigInsQuartzCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected MigInsQuartz pojo;
	protected MigInsQuartzService dataService;
...
//	}
	...
	public String add() {
		try{
			dataService.add(super.getJdata(), super.getLoginUser(),super.getRemoteAddr());
		}catch(Exception e){
			e.printStackTrace();
			Throwable e2 = e;
	...
	public String modify(){
		...
		try{
			...
			i = dataService.modify(super.getJdata(), super.getLoginUser(),super.getRemoteAddr());
		}catch(Exception e){
			e.printStackTrace();
			Throwable e2 = e;
			while(e2.getCause() != null ){
	...
	public String delete(){
		...
		try{
			//@return The number of entities updated or deleted or insert.
			i = dataService.delete(super.getJdata(), super.getLoginUser(),super.getRemoteAddr());
		}catch(Exception e){
			e.printStackTrace();
			Throwable e2 = e;
			while(e2.getCause() != null ){
	...
	public void setPojo(MigInsQuartz pojo) {
		this.pojo = pojo;
	}
	/**
	 ...
	 * @return
	 */
	public MigInsQuartz getPojo() {
		return pojo;
	}
	public void setDataService(MigInsQuartzService dataService) {
