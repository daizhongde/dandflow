 ...
 * @date 2015-01-07
 */
public class MigAuditvConfigCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected MigAuditvConfigService dataService;
	/** To solve + disapear problem */
...
//	}
	...
	public String add() {
		try{
			id = dataService.add(this.getJdata(), super.getLoginUser());
		}catch(Exception e){
			e.printStackTrace();
			Throwable e2 = e;
	...
	public String initModify() {
		this.map = dataService.browse( this.getJdata() );
		return "mig_modify";
	}
	...
	public String modify(){
		...
		try{
			...
			i = dataService.modify(this.getJdata());
		}catch(Exception e){
			e.printStackTrace();
			Throwable e2 = e;
			while(e2.getCause() != null ){
	...
	public String delete(){
		...
		try{
			//@return The number of entities updated or deleted or insert.
			i = dataService.delete(this.getJdata());
		}catch(Exception e){
			e.printStackTrace();
			Throwable e2 = e;
			while(e2.getCause() != null ){
	...
	public String browse(){
		map = dataService.browse(this.getJdata() );

		return "mig_browse";
	}
	
	/**
	 * Front page get pojo by id
	 * @return map
	 */
	public String browseById(){
//		Object config= dataService.browsePOJOById(id);
		Object config= dataService.browseById(id);
		super.setJson(config);
		return "json";
	}
	...
	public void setDataService(MigAuditvConfigService dataService) {
