 ...
 * @date 2015-01-07
 */
public class MigCodedetailDefineCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected MigCodedetailDefine pojo;
	protected MigCodedetailDefineService dataService;
...
//		log.debug("encoded jdata:" + jdata.toString());
	...
	public void setPojo(MigCodedetailDefine pojo) {
		this.pojo = pojo;
	}
	/**
	 ...
	 * @return
	 */
	public MigCodedetailDefine getPojo() {
		return pojo;
	}
	public void setDataService(MigCodedetailDefineService dataService) {
