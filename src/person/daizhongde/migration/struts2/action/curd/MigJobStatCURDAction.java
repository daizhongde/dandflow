 ...
 * @date 2015-01-07
 */
public class MigJobStatCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected MigJobStat pojo;
	protected MigJobStatService dataService;
...
//		log.debug("encoded jdata:" + jdata.toString());
	...
	public void setPojo(MigJobStat pojo) {
		this.pojo = pojo;
	}
	/**
	 ...
	 * @return
	 */
	public MigJobStat getPojo() {
		return pojo;
	}
	public void setDataService(MigJobStatService dataService) {
