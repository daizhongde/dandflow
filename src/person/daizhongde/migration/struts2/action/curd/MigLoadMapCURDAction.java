 ...
 * @date 2015-01-07
 */
public class MigLoadMapCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected MigLoadMap pojo;
	protected MigLoadMapService dataService;
...
//		log.debug("encoded jdata:" + jdata.toString());
	...
	public void setPojo(MigLoadMap pojo) {
		this.pojo = pojo;
	}
	/**
	 ...
	 * @return
	 */
	public MigLoadMap getPojo() {
		return pojo;
	}
	public void setDataService(MigLoadMapService dataService) {
