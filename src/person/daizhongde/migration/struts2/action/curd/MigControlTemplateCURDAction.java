 ...
 * @date 2015-01-07
 */
public class MigControlTemplateCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected MigControlTemplate pojo;
	protected MigControlTemplateService dataService;
...
//		log.debug("encoded jdata:" + jdata.toString());
	...
	public void setPojo(MigControlTemplate pojo) {
		this.pojo = pojo;
	}
	/**
	 ...
	 * @return
	 */
	public MigControlTemplate getPojo() {
		return pojo;
	}
	public void setDataService(MigControlTemplateService dataService) {
