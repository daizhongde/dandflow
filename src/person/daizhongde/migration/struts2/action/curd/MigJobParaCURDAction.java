 ...
 * @date 2015-01-07
 */
public class MigJobParaCURDAction extends BaseAction {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5740995995412971143L;
	...
	protected MigJobPara pojo;
	protected MigJobParaService dataService;
...
//		log.debug("encoded jdata:" + jdata.toString());
	...
	public void setPojo(MigJobPara pojo) {
		this.pojo = pojo;
	}
	/**
	 ...
	 * @return
	 */
	public MigJobPara getPojo() {
		return pojo;
	}
	public void setDataService(MigJobParaService dataService) {
