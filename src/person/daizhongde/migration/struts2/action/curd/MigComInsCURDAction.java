 ...
 * @date 2015-01-07
 */
public class MigComInsCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected MigComIns pojo;
	protected MigComInsService dataService;
...
//	}
	...
	public String modifySQL(){
		...
		try{
			//@return The number of entities updated or deleted or insert.
			//jobInsId:'"+jobInsId+"',comId:'"+comId+"',paraId:"+paraId
			dataService.modifySQL( super.get("jobInsId"), super.get("comId"),super.getInt("paraId"),
					paraValue );
		}catch(Exception e){
			e.printStackTrace();
			Throwable e2 = e;
	...
	public String modifyParas(){
		JSONObject json = StringUtils.isEmpty( super.getJdata() )?null:JSONObject.fromObject( super.getJdata() );
		super.setJsonObject(json);
		
		try{
			//@return The number of entities updated or deleted or insert.
//			dataService.modifyPara(
//					super.get("comId"),
//					super.getMapValue("paras")
//				);
		}catch(Exception e){
			e.printStackTrace();
			Throwable e2 = e;
	...
	public void setPojo(MigComIns pojo) {
		this.pojo = pojo;
	}
	/**
	 ...
	 * @return
	 */
	public MigComIns getPojo() {
		return pojo;
	}
	public void setDataService(MigComInsService dataService) {
