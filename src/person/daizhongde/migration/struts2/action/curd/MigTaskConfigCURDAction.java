 ...
 * @date 2015-01-07
 */
public class MigTaskConfigCURDAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected MigTaskConfig pojo;
	protected MigTaskConfigService dataService;
	...
	public void setJdata(String row) throws UnsupportedEncodingException {
...
//		log.debug("#######");
	...
	public String add() {
		try{
			dataService.add( row , super.getLoginUser());
		}catch(Exception e){
			e.printStackTrace();
			Throwable e2 = e;
	...
	public String initModify() {
		this.map = dataService.browse( row );
		return "mig_modify";
	}
	...
	public void setPojo(MigTaskConfig pojo) {
		this.pojo = pojo;
	}
	/**
	 ...
	 * @return
	 */
	public MigTaskConfig getPojo() {
		return pojo;
	}
	public void setDataService(MigTaskConfigService dataService) {
