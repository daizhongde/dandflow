 ...
 *
 */
public class MigTaskConfigTREEAction extends BaseAction {
	...
	private MigTaskConfigService dataService;
...
//	private JSONObject json;
	...
	public String query_JEasyUI_Tree(){
		log.debug("配置参数........query_JEasyUI_Tree............");
		//取得ActionContext实例
...
//		System.out.println("id:"+id);
		if( id == 0 ){
			this.json = dataService.getData_JEasyUI_Tree(type);
		}else{
	...
	public String query_JEasyUI_CheckBoxTree(){
		log.debug("配置参数........query_JEasyUI_CheckBoxTree............");
		//取得ActionContext实例
		ActionContext ctx = ActionContext.getContext();
		//通过ActionContext访问用户的HttpSession
		Map session = ctx.getSession();
...
//		System.out.println("id:"+id);
		if( id == 0 ){
			this.json = dataService.getData_JEasyUI_CheckBoxTree(type);
		}else{
			this.json = new ArrayList();;
		}
		return SUCCESS;
