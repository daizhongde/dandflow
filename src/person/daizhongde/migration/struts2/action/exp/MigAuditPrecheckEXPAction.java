 ...
 * 
 */
public class MigAuditPrecheckEXPAction extends BaseAction  {
	/**
	 * 
	 */
...
//		TimestampFormat	: "",////or "YYYYMMDD","YYYY-MM-DD-HHNNSS"
		...
		case "xls": iso88951 = cv.getGBK2ISO( absConstant.getEXPfileName() + (++countXLS) + Timestamp + ".xls");
			break;
		case "txt": iso88951= cv.getGBK2ISO( absConstant.getEXPfileName() + (++countTXT) + Timestamp + ".txt");
			break;
	 ...
	 * ConstMigAuditPrecheck.Export.export  --ExportXLS()
	 * ConstMigAuditPrecheck.Export.exportDayReport  --ExportDayReportXLS()
	 * ConstMigAuditPrecheck.Export.exportMonthReport  --ExportMonthReportXLS()
	 * @throws Throwable 
	 * 
	 * 
	 * 
	...
	public String exportXLS() throws Throwable{
		return this.precheckXLS();
	}
	/**
	 * 处理用户导出文件的方法
	 * 同步导出(以提交form的形式导出)
	 * 
	 * @see person.daizhongde.migration.struts2.action.exp.MigAuditPrecheckEXPAction#ExportXLS()
	 * @throws Throwable 
	 * 
	 */
	 ...
	 * 
	 */
	public String precheckXLS() throws Throwable{
