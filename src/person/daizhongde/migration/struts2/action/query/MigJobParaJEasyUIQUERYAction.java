 ...
 * @date 2015-01-07
 */
public class MigJobParaJEasyUIQUERYAction extends BaseAction {
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigJobPara");
		AbstractConstant absConstant = new ConstMigJobPara();
...
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "MigJobPara");
