 ...
 * @date 2015-01-07
 */
public class MigInsParaJEasyUIQUERYAction extends BaseAction {
	...
	protected MigInsParaService dataService;
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigInsPara");
		AbstractConstant absConstant = new ConstMigInsPara();
...
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "MigInsPara");
...
//	}
	...
	public void setDataService(MigInsParaService dataService) {
