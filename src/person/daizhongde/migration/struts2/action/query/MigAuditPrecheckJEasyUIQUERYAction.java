 ...
 * @date 2015-01-07
 */
public class MigAuditPrecheckJEasyUIQUERYAction extends BaseAction {
	...
	protected MigAuditPrecheckService dataService;
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigAuditPrecheck");
		AbstractConstant absConstant = new ConstMigAuditPrecheck();
...
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "MigAuditPrecheck");
...
//	}
	...
	public void setDataService(MigAuditPrecheckService dataService) {
