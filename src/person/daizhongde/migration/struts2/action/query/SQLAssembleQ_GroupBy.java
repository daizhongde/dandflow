...
//	private String[] sort;
	 ...
	 * @param absConstant
	 */
	public SQLAssembleQ_GroupBy(ConfigDocument_SQL  sqlDoc, String selectSQL, Map condition, Map operator, 
...
//		System.out.println("##map.size():"+map.size());
		...
		if( this.condition == null || this.condition.size() == 0 ){
			...
			this.countSQL = "select count(*) " + fromSQL + " " + "having " + this.whereBackSQL;
			this.SQL = selectSQL + " having " + this.whereBackSQL;
		}
		
		this.SQL += SQLUtil.getOrderSQL(this.sort);
		System.out.println("SQLA_Q GroupBy countSQL:"+countSQL);
		System.out.println("SQLA_Q GroupBy SQL:"+SQL);
	}
