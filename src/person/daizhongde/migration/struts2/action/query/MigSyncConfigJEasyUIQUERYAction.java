 ...
 * @date 2015-01-07
 */
public class MigSyncConfigJEasyUIQUERYAction extends BaseAction {
	...
	protected MigSyncConfigService dataService;
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigSyncConfig");
		AbstractConstant absConstant = new ConstMigSyncConfig();
...
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "MigSyncConfig");
...
//	}
	...
	public void setDataService(MigSyncConfigService dataService) {
