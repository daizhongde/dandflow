 ...
 * @date 2015-01-07
 */
public class MigAuditfFieldResultJEasyUIQUERYAction extends BaseAction {
	...
	protected MigAuditfFieldResultService dataService;
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigAuditfFieldResult");
		AbstractConstant absConstant = new ConstMigAuditfFieldResult();
...
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "MigAuditfFieldResult");
...
//	}
	...
	public void setDataService(MigAuditfFieldResultService dataService) {
