 ...
 * @date 2015-01-07
 */
public class MigJobLogJEasyUIQUERYAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected MigJobLogService dataService;
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject( super.getJdata() );
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigJobLog");
		AbstractConstant absConstant = new ConstMigJobLog();
...
//			JdataChecker checker = new JdataChecker(jsonObject, "MigJobLog");
