 ...
 * @date 2015-01-07
 */
public class MigAuditvConfigJEasyUIQUERYAction extends BaseAction {
	...
	public String dfind2() {
		...
		SQLAssembleQ sqlA = new SQLAssembleQ(
				absConstant.getSQLDOC(),
				absConstant.getSQLDOC().getQuery().get("querySingleCollDetail").getSQL(),
				jsonObject.getJSONObject("condition"), 
				jsonObject.getJSONObject("operator"),
				absConstant.getColumnTypes(),
				absConstant.getFront2col(),
...
//		params.put("main_id", jsonObject.getJSONObject("condition").getInt("main_id"));
//		sqlA.setMap(params);
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigAuditvConfig");
		AbstractConstant absConstant = new ConstMigAuditvConfig();
...
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "MigAuditvConfig");
