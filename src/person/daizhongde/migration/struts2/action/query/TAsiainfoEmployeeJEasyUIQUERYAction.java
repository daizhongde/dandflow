 ...
 * @date 2015-01-07
 */
public class TAsiainfoEmployeeJEasyUIQUERYAction extends BaseAction {
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "TAsiainfoEmployee");
		AbstractConstant absConstant = new ConstTAsiainfoEmployee();
...
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "TAsiainfoEmployee");
