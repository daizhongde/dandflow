 ...
 * @date 2015-01-07
 */
public class MigTaskInfoJEasyUIQUERYAction extends BaseAction {
	/**
	 * 
	 */
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject( super.getJdata() );
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigTaskInfo");
		AbstractConstant absConstant = new ConstMigTaskInfo();
...
//			JdataChecker checker = new JdataChecker(jsonObject, "MigTaskInfo");
