 ...
 * @date 2015-01-07
 */
public class MigJobInsCBBQUERYAction extends BaseAction {
	/**
	 * 
	 */
	...
	protected MigJobInsService dataService;
	...
	public String dfind() {
		...
		if( StringUtils.isNotEmpty(q) ){
			condition.put("job_ins_name", q );
			operator.put("job_ins_name", Operator.CONTAIN );
		}
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject( super.getJdata() );
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigJobIns");
		AbstractConstant absConstant = new ConstMigJobIns();
