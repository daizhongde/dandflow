 ...
 * @date 2015-01-07
 */
public class MigAuditfDetailResultJEasyUIQUERYAction extends BaseAction {
	...
	protected MigAuditfDetailResultService dataService;
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigAuditfDetailResult");
		AbstractConstant absConstant = new ConstMigAuditfDetailResult();
...
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "MigAuditfDetailResult");
...
//	}
	...
	public void setDataService(MigAuditfDetailResultService dataService) {
