 ...
 * @date 2015-01-07
 */
public class MigAuditfMainJEasyUIQUERYAction extends BaseAction {
	...
	protected MigAuditfMainService dataService;
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigAuditfMain");
		AbstractConstant absConstant = new ConstMigAuditfMain();
...
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "MigAuditfMain");
