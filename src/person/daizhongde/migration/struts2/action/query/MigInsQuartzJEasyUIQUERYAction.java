 ...
 * @date 2015-01-07
 */
public class MigInsQuartzJEasyUIQUERYAction extends BaseAction {
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigInsQuartz");
		AbstractConstant absConstant = new ConstMigInsQuartz();
...
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "MigInsQuartz");
