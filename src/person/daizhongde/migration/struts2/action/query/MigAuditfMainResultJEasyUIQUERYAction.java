 ...
 * @date 2015-01-07
 */
public class MigAuditfMainResultJEasyUIQUERYAction extends BaseAction {
	...
	protected MigAuditfMainResultService dataService;
	...
	public String dfindArray() {
		...
		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		SQLAssemble2 sqlA = new SQLAssemble2(jsonObject, "MigAuditfMainResult");
		AbstractConstant absConstant = new ConstMigAuditfMainResult();
...
//			JSONObject jsonObject = JSONObject.fromObject(jdata);
//			JdataChecker checker = new JdataChecker(jsonObject, "MigAuditfMainResult");
...
//	}
	...
	public void setDataService(MigAuditfMainResultService dataService) {
