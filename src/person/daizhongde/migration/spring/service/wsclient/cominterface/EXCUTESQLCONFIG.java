...
/**
 * <p>EXCUTESQLCONFIG complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="EXCUTESQLCONFIG">
 *   &lt;complexContent>
 ...
 *         &lt;element name="dst-conn" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="exec-sql" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "EXCUTESQLCONFIG", propOrder = {
    "taskId",
    "jobId",
    "jobInsId",
    "dryrunId",
...
public class EXCUTESQLCONFIG {
    ...
    @XmlElementRef(name = "dst-conn", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dstConn;
    @XmlElementRef(name = "exec-sql", type = JAXBElement.class, required = false)
    protected JAXBElement<String> execSql;
     ...
     *     
     */
    public JAXBElement<String> getDstConn() {
        return dstConn;
    }
     ...
     *     
     */
    public void setDstConn(JAXBElement<String> value) {
        this.dstConn = value;
    }
     ...
     *     
     */
    public JAXBElement<String> getExecSql() {
        return execSql;
    }
     ...
     *     
     */
    public void setExecSql(JAXBElement<String> value) {
        this.execSql = value;
    }
