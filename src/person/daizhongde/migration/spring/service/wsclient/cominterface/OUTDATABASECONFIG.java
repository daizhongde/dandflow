...
/**
 * <p>OUTDATABASECONFIG complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="OUTDATABASECONFIG">
 *   &lt;complexContent>
 ...
 *         &lt;element name="isClearTable" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "OUTDATABASECONFIG", propOrder = {
    "taskId",
    "jobId",
    "jobInsId",
    "dryrunId",
...
public class OUTDATABASECONFIG {
    ...
    @XmlElementRef(name = "isClearTable", type = JAXBElement.class, required = false)
    protected JAXBElement<String> isClearTable;
     ...
     *     
     */
    public JAXBElement<String> getIsClearTable() {
        return isClearTable;
    }
     ...
     *     
     */
    public void setIsClearTable(JAXBElement<String> value) {
        this.isClearTable = value;
    }
