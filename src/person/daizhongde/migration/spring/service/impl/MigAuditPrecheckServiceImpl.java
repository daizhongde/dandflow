...
import person.daizhongde.migration.constant.ConstMigAuditPrecheck;
...
import person.daizhongde.migration.spring.service.MigAuditPrecheckService;

public class MigAuditPrecheckServiceImpl implements MigAuditPrecheckService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private MigAuditPrecheckDAO dataDAO;
...
//		System.out.println("o:"+o);
	...
	public int add(String jdata) {
		...
		AbstractConstant absConstant = new ConstMigAuditPrecheck();
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditPrecheckService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigAuditPrecheck pojo = new MigAuditPrecheck();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditPrecheckService#modify(java.lang.String)
	 */
	@Override
	...
	public MigAuditPrecheck browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigAuditPrecheck();
		...
		return (MigAuditPrecheck)dataDAO.listAllByMap( "from MigAuditPrecheck t1 where "+hqlA.getWhereBackHQL(), hqlA.getMap() ).get(0);
	}
	public MigAuditPrecheck browsePOJOById(long id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	public MigAuditPrecheck browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditPrecheckService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigAuditPrecheckDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigAuditPrecheckService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigAuditPrecheckService) ctx.getBean("migAuditPrecheckService");
	}
}
