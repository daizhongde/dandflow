...
import person.daizhongde.migration.constant.ConstMigAuditcEnumMapping;
...
import person.daizhongde.migration.spring.service.MigAuditcEnumMappingService;

public class MigAuditcEnumMappingServiceImpl implements MigAuditcEnumMappingService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private MigAuditcEnumMappingDAO dataDAO;
...
//		System.out.println("o:"+o);
	...
	public int add(String jdata) {
		...
		AbstractConstant absConstant = new ConstMigAuditcEnumMapping();
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditcEnumMappingService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigAuditcEnumMapping pojo = new MigAuditcEnumMapping();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditcEnumMappingService#modify(java.lang.String)
	 */
	@Override
	...
	public MigAuditcEnumMapping browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigAuditcEnumMapping();
...
//		return dataDAO.findById((short)id);
	...
	public MigAuditcEnumMapping browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditcEnumMappingService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigAuditcEnumMappingDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigAuditcEnumMappingService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigAuditcEnumMappingService) ctx.getBean("migAuditcEnumMappingService");
	}
