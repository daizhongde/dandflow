...
public class TCopoteEmployeeServiceImpl implements TCopoteEmployeeService {
...
//		System.out.println("o:"+o);
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.TCopoteEmployeeService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		TCopoteEmployee pojo = new TCopoteEmployee();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.TCopoteEmployeeService#modify(java.lang.String)
	 */
	@Override
	...
	public TCopoteEmployee browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstTCopoteEmployee();
...
//		return dataDAO.findById((short)id);
	...
	public TCopoteEmployee browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.TCopoteEmployeeService#delete(java.lang.String)
	 */
	@Override
	...
	public static TCopoteEmployeeService getFromApplicationContext(
			ApplicationContext ctx) {
		return (TCopoteEmployeeService) ctx.getBean("TCopoteEmployeeService");
	}
