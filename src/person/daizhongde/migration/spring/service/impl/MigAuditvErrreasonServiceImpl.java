...
import person.daizhongde.migration.constant.ConstMigAuditvErrreason;
...
public class MigAuditvErrreasonServiceImpl implements MigAuditvErrreasonService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private MigAuditvErrreasonDAO dataDAO;
	
	public void inputReason( String jdata, TAuthorityUser user ){
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigAuditvErrreason();
		...
		if( dataDAO.sqlQueryExeUByMap(sqlA.getSQL(), sqlA.getMap())!=1 ){
			//insert
			SQLAssembleC sqlAC = new SQLAssembleC(
					absConstant.getTableName(),
					jsonObject.getJSONObject("data"),
					absConstant.getColumnTypes(),
					absConstant.getFront2col()
			...
			dataDAO.sqlQueryExeUByMap(sqlAC.getSQL(), sqlAC.getMap());
		}		
	}
...
//		System.out.println("o:"+o);
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditvErrreasonService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigAuditvErrreason pojo = new MigAuditvErrreason();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditvErrreasonService#modify(java.lang.String)
	 */
	@Override
	...
	public MigAuditvErrreason browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigAuditvErrreason();
...
//		return dataDAO.findById((short)id);
	...
	public MigAuditvErrreason browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditvErrreasonService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigAuditvErrreasonDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigAuditvErrreasonService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigAuditvErrreasonService) ctx.getBean("migAuditvErrreasonService");
	}
