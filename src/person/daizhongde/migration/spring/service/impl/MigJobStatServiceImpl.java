...
import person.daizhongde.migration.constant.ConstMigJobStat;
...
import person.daizhongde.migration.spring.service.MigJobStatService;

public class MigJobStatServiceImpl implements MigJobStatService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private MigJobStatDAO dataDAO;
...
//		System.out.println("o:"+o);
	...
	public int add(String jdata) {
		...
		AbstractConstant absConstant = new ConstMigJobStat();
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigJobStatService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigJobStat pojo = new MigJobStat();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigJobStatService#modify(java.lang.String)
	 */
	@Override
	...
	public MigJobStat browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigJobStat();
		...
		return (MigJobStat)dataDAO.listAllByMap( "from MigJobStat t1 where "+hqlA.getWhereBackHQL(), hqlA.getMap() ).get(0);
	}
	public MigJobStat browsePOJOById(long id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	public MigJobStat browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigJobStatService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigJobStatDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigJobStatService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigJobStatService) ctx.getBean("migJobStatService");
	}
