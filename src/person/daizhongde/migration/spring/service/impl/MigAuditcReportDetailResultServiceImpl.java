...
import person.daizhongde.migration.spring.service.MigAuditcReportDetailResultService;

public class MigAuditcReportDetailResultServiceImpl implements MigAuditcReportDetailResultService {
...
//		System.out.println("o:"+o);
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditcReportDetailResultService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigAuditcReportDetailResult pojo = new MigAuditcReportDetailResult();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditcReportDetailResultService#modify(java.lang.String)
	 */
	@Override
	...
	public MigAuditcReportDetailResult browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigAuditcReportDetailResult();
...
//		return dataDAO.findById((short)id);
	...
	public MigAuditcReportDetailResult browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditcReportDetailResultService#delete(java.lang.String)
	 */
	@Override
	...
	public static MigAuditcReportDetailResultService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigAuditcReportDetailResultService) ctx.getBean("migAuditcReportDetailResultService");
	}
