...
import person.daizhongde.migration.constant.ConstMigControlTemplate;
...
import person.daizhongde.migration.spring.service.MigControlTemplateService;

public class MigControlTemplateServiceImpl implements MigControlTemplateService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private MigControlTemplateDAO dataDAO;
	
	public List<MigControlTemplate> getControlTemplateByCtlId(String ctlId){
		if(ctlId==null || "".equals(ctlId)){
			log.error("ctlid incorrect");
			return null;
		}	
		return dataDAO.getControlTemplateByCtlId(ctlId);	
	}	
...
//		System.out.println("o:"+o);
	...
	public int add(String jdata) {
		...
		AbstractConstant absConstant = new ConstMigControlTemplate();
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigControlTemplateService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigControlTemplate pojo = new MigControlTemplate();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigControlTemplateService#modify(java.lang.String)
	 */
	@Override
	...
	public MigControlTemplate browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigControlTemplate();
...
//		return dataDAO.findById((short)id);
	...
	public MigControlTemplate browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigControlTemplateService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigControlTemplateDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigControlTemplateService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigControlTemplateService) ctx.getBean("migControlTemplateService");
	}
