...
import person.daizhongde.migration.spring.service.MigSyncConfigService;

public class MigSyncConfigServiceImpl implements MigSyncConfigService {
...
//		System.out.println("o:"+o);
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigSyncConfigService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigSyncConfig pojo = new MigSyncConfig();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigSyncConfigService#modify(java.lang.String)
	 */
	@Override
	...
	public MigSyncConfig browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigSyncConfig();
...
//		return dataDAO.findById((short)id);
	...
	public MigSyncConfig browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigSyncConfigService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigSyncConfigDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigSyncConfigService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigSyncConfigService) ctx.getBean("migSyncConfigService");
	}
