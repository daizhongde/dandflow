...
import person.daizhongde.migration.constant.ConstMigInsConfig;
...
import person.daizhongde.migration.spring.service.MigInsConfigService;

public class MigInsConfigServiceImpl implements MigInsConfigService {

	private Logger log = LoggerFactory.getLogger(this.getClass());

	private MigInsConfigDAO dataDAO;
	...
	public int add(String jdata) {
		...
		AbstractConstant absConstant = new ConstMigInsConfig();
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigInsConfigService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigInsConfig pojo = new MigInsConfig();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigInsConfigService#modify(java.lang.String)
	 */
	@Override
	...
	public MigInsConfig browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigInsConfig();
...
//		return dataDAO.findById((short)id);
	...
	public MigInsConfig browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigInsConfigService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigInsConfigDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigInsConfigService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigInsConfigService) ctx.getBean("migInsConfigService");
	}
