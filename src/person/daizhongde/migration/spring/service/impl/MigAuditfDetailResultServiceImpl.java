...
import person.daizhongde.migration.constant.ConstMigAuditfDetailResult;
...
import person.daizhongde.migration.spring.service.MigAuditfDetailResultService;

public class MigAuditfDetailResultServiceImpl implements MigAuditfDetailResultService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private MigAuditfDetailResultDAO dataDAO;
...
//		System.out.println("o:"+o);
	...
	public int add(String jdata) {
		...
		AbstractConstant absConstant = new ConstMigAuditfDetailResult();
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditfDetailResultService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigAuditfDetailResult pojo = new MigAuditfDetailResult();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditfDetailResultService#modify(java.lang.String)
	 */
	@Override
	...
	public MigAuditfDetailResult browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigAuditfDetailResult();
...
//		return dataDAO.findById((short)id);
	...
	public MigAuditfDetailResult browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditfDetailResultService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigAuditfDetailResultDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigAuditfDetailResultService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigAuditfDetailResultService) ctx.getBean("migAuditfDetailResultService");
	}
