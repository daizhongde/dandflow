...
import person.daizhongde.migration.spring.service.MigAuditfMainResultService;

public class MigAuditfMainResultServiceImpl implements MigAuditfMainResultService {
...
//		System.out.println("o:"+o);
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditfMainResultService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigAuditfMainResult pojo = new MigAuditfMainResult();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditfMainResultService#modify(java.lang.String)
	 */
	@Override
	...
	public MigAuditfMainResult browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigAuditfMainResult();
		...
		return (MigAuditfMainResult)dataDAO.listAllByMap( "from MigAuditfMainResult t1 where "+hqlA.getWhereBackHQL(), hqlA.getMap() ).get(0);
	}
	public MigAuditfMainResult browsePOJOById(int id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	public MigAuditfMainResult browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditfMainResultService#delete(java.lang.String)
	 */
	@Override
	...
	public static MigAuditfMainResultService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigAuditfMainResultService) ctx.getBean("migAuditfMainResultService");
	}
