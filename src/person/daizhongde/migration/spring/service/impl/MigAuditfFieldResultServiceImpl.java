...
import person.daizhongde.migration.constant.ConstMigAuditfFieldResult;
...
import person.daizhongde.migration.spring.service.MigAuditfFieldResultService;

public class MigAuditfFieldResultServiceImpl implements MigAuditfFieldResultService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private MigAuditfFieldResultDAO dataDAO;
...
//		System.out.println("o:"+o);
	...
	public int add(String jdata) {
		...
		AbstractConstant absConstant = new ConstMigAuditfFieldResult();
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditfFieldResultService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigAuditfFieldResult pojo = new MigAuditfFieldResult();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditfFieldResultService#modify(java.lang.String)
	 */
	@Override
	...
	public MigAuditfFieldResult browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigAuditfFieldResult();
		...
		return (MigAuditfFieldResult)dataDAO.listAllByMap( "from MigAuditfFieldResult t1 where "+hqlA.getWhereBackHQL(), hqlA.getMap() ).get(0);
	}
	public MigAuditfFieldResult browsePOJOById(long id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	public MigAuditfFieldResult browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditfFieldResultService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigAuditfFieldResultDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigAuditfFieldResultService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigAuditfFieldResultService) ctx.getBean("migAuditfFieldResultService");
	}
