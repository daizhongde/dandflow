...
public class MigCodedetailDefineServiceImpl implements MigCodedetailDefineService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private MigCodedetailDefineDAO dataDAO;
	
	public  void newStaticPara(MigCodedetailDefine mpd){
		if(mpd!=null)
			dataDAO.save(mpd);
		log.debug("newStaticPara success");
	}
	  public  void updateStaticParaValue(Map<String,String> paras){
		  if(paras!=null)
		    dataDAO.updateById(paras);
		  log.debug("updateStaticParaValue success");

	  }
	  public  void delStaticPara(String para){
		  if(para!=null)
		  dataDAO.deleteById(para);
		  log.debug("delStaticPara  success");

	  }
	  
	  public  List<MigCodedetailDefine> findAllStaticPara(){
		  return dataDAO.findAll();
	  }
	
    @Override
    public List<MigCodedetailDefine> queryList(MigCodedetailDefine dictionary) {
...
//		System.out.println("o:"+o);
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigCodedetailDefineService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigCodedetailDefine pojo = new MigCodedetailDefine();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigCodedetailDefineService#modify(java.lang.String)
	 */
	@Override
	...
	public MigCodedetailDefine browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigCodedetailDefine();
...
//		return dataDAO.findById((short)id);
	...
	public MigCodedetailDefine browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigCodedetailDefineService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigCodedetailDefineDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigCodedetailDefineService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigCodedetailDefineService) ctx.getBean("migStaticprarDefineService");
	}
