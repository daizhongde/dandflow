...
import person.daizhongde.migration.constant.ConstMigAuditcConsistency;
...
import person.daizhongde.migration.spring.service.MigAuditcConsistencyService;

public class MigAuditcConsistencyServiceImpl implements MigAuditcConsistencyService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private MigAuditcConsistencyDAO dataDAO;
...
//		System.out.println("o:"+o);
	...
	public int add(String jdata) {
		...
		AbstractConstant absConstant = new ConstMigAuditcConsistency();
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditcConsistencyService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigAuditcConsistency pojo = new MigAuditcConsistency();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditcConsistencyService#modify(java.lang.String)
	 */
	@Override
	...
	public MigAuditcConsistency browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigAuditcConsistency();
...
//		return dataDAO.findById((short)id);
	...
	public MigAuditcConsistency browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigAuditcConsistencyService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigAuditcConsistencyDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigAuditcConsistencyService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigAuditcConsistencyService) ctx.getBean("migAuditcConsistencyService");
	}
