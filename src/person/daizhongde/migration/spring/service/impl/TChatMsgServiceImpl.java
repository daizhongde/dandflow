...
import person.daizhongde.migration.constant.ConstTChatMsg;
import person.daizhongde.migration.hibernate.dao.TChatMsgDAO;
import person.daizhongde.migration.hibernate.pojo.TChatMsg;
import person.daizhongde.migration.spring.service.TChatMsgService;

public class TChatMsgServiceImpl implements TChatMsgService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private TChatMsgDAO dataDAO;
...
//		System.out.println("o:"+o);
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.TChatMsgService#addWithId(java.lang.String)
	 */
	@Override
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.TChatMsgService#modify(java.lang.String)
	 */
	@Override
	...
	public TChatMsg browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstTChatMsg();
...
//		return dataDAO.findById((short)id);
	...
	public TChatMsg browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.TChatMsgService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(TChatMsgDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static TChatMsgService getFromApplicationContext(
			ApplicationContext ctx) {
		return (TChatMsgService) ctx.getBean("TChatMsgService");
	}
