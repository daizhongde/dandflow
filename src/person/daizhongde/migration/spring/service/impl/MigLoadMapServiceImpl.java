...
import person.daizhongde.migration.constant.ConstMigLoadMap;
...
import person.daizhongde.migration.spring.service.MigLoadMapService;

public class MigLoadMapServiceImpl implements MigLoadMapService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private MigLoadMapDAO dataDAO;
...
//		System.out.println("o:"+o);
	...
	public int add(String jdata) {
		...
		AbstractConstant absConstant = new ConstMigLoadMap();
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigLoadMapService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigLoadMap pojo = new MigLoadMap();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigLoadMapService#modify(java.lang.String)
	 */
	@Override
	...
	public MigLoadMap browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigLoadMap();
...
//		return dataDAO.findById((short)id);
	...
	public MigLoadMap browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigLoadMapService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigLoadMapDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigLoadMapService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigLoadMapService) ctx.getBean("migLoadMapService");
	}
