...
import person.daizhongde.migration.constant.ConstMigDataPrecheck;
...
import person.daizhongde.migration.spring.service.MigDataPrecheckService;

public class MigDataPrecheckServiceImpl implements MigDataPrecheckService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	private MigDataPrecheckDAO dataDAO;
...
//		System.out.println("o:"+o);
	...
	public int add(String jdata) {
		...
		AbstractConstant absConstant = new ConstMigDataPrecheck();
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigDataPrecheckService#addWithId(java.lang.String)
	 */
	@Override
...
//				);
	...
	public void addBySavePOJO(String jdata) {
		...
		MigDataPrecheck pojo = new MigDataPrecheck();
		Map map =sqlA.getMap();
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigDataPrecheckService#modify(java.lang.String)
	 */
	@Override
	...
	public MigDataPrecheck browsePOJO(String jdata) {
		JSONObject jsonObject = JSONObject.fromObject(jdata);
		AbstractConstant absConstant = new ConstMigDataPrecheck();
...
//		return dataDAO.findById((short)id);
	...
	public MigDataPrecheck browsePOJOById(String id) {
//		return dataDAO.findById((short)id);
		return null;
	}
	/* (non-Javadoc)
	 * @see person.daizhongde.authority.spring.service.impl.MigDataPrecheckService#delete(java.lang.String)
	 */
	@Override
	...
	public void setDataDAO(MigDataPrecheckDAO dataDAO) {
		this.dataDAO = dataDAO;
	}

	public static MigDataPrecheckService getFromApplicationContext(
			ApplicationContext ctx) {
		return (MigDataPrecheckService) ctx.getBean("migDataPrecheckService");
	}
