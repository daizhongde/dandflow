...
public class MigAuditPrecheckServiceImpl_EXP implements BaseExportService {

	private static final Log log = LogFactory.getLog(MigAuditPrecheckServiceImpl_EXP.class);
...
//					currentSheetRecordCount, bw, sheetNumber * pageSize );
	...
	public static BaseExportService getFromApplicationContext(
		...
		return (BaseExportService) ctx.getBean("migAuditPrecheckService_EXP");
	}
	@Override
