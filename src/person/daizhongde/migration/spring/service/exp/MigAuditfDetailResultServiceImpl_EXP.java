...
public class MigAuditfDetailResultServiceImpl_EXP implements BaseExportService {

	private static final Log log = LogFactory.getLog(MigAuditfDetailResultServiceImpl_EXP.class);
...
//					currentSheetRecordCount, bw, sheetNumber * pageSize );
	...
	public static BaseExportService getFromApplicationContext(
		...
		return (BaseExportService) ctx.getBean("migAuditfDetailResultService_EXP");
	}
	@Override
