...
public class MigAuditfFieldResultServiceImpl_EXP implements BaseExportService {

	private static final Log log = LogFactory.getLog(MigAuditfFieldResultServiceImpl_EXP.class);
...
//					currentSheetRecordCount, bw, sheetNumber * pageSize );
	...
	public static BaseExportService getFromApplicationContext(
		...
		return (BaseExportService) ctx.getBean("migAuditfFieldResultService_EXP");
	}
	@Override
