...
//            return;
//        }
//    	String sourceFile="模块信息140919-080347-647.xls";
//    	String sourceFile="#SQL_template.xlsx";
    	String sourceFile="模板-sample-result.xlsx";
    	
        args = new String[]{"D:\\usr\\authorityfile\\temp\\export\\excel\\"+sourceFile,
        		"D:\\usr\\authorityfile\\temp\\export\\excel\\temp.html"};
...
//        ToHtml toHtml = create(args[0], new PrintWriter(new FileWriter(args[1])));
        ToHtml toHtml = create(args[0], 
        		new PrintWriter(new BufferedWriter(new OutputStreamWriter(new FileOutputStream(args[1]),"GBK"))));
